...
Du coté de la centrale, on doit avoir une table de type Sensor
...
2 bit avec la convention suivante~:

Chaque aiguille est représenté sur 2 bits. Le \textbf{bit paire} représente la
demande d'aiguillage à gauche. Le \textbf{bit impaire} représente la demande
d'aiguillage à droite.

\medskip

Pour chaque bit voici ce que leur valeurs représente :
\begin{itemize}
\item 0 = \textbf{pas de demande} de commande de aiguille
\item 1 = \textbf{demande} de commande de aiguille
\end{itemize}
Les deux bit doivent être exclusif mutuelement, il ne peut y en avoir
...
L'état d'un aiguillage sera représenté par 2 bit avec la même
