...
La coeur de la gestion
  ...
  \begin{itemize}
    \item \emph{commandé}. L'opérateur veut que le train parcourt
      l'itinéraire, il a par conséquent demandé la formation de
      l'itinéraire au système d'enclenchement. Si les conditions sur
      les aiguilles à manoeuvrer pour former l'itinéraire sont
      correctes, le système d'enclenchement passe à l'état formation de
      l'itinéraire sinon l'itinéraire est rejeté.
...
``C`` en utilisant des aiguillages choisient à l'avance.
\newline
\newline
